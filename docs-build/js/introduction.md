...
[//]: # (This was insert by build job. Edit file ./docs/code/introduction-example.js Then build:docs) 
[Javascript]("docs-build/js/introduction.md#introduction-example) | [Typscript]("./docs-build/js/introduction.md) 
 ### <a name="introduction-example"></a>```javascript
